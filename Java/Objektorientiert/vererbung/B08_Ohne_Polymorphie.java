...
public class B08_Ohne_Polymorphie {
	...
	public static void main(String[] args) {
		...
		statenUndFahren2(new PKW());
		statenUndFahren2(new Fahrrad());
		
	}

	static void statenUndFahren2(PKW fahrzeug) 		{ fahrzeug.fahren();}
	
	static void statenUndFahren2(Fahrrad fahrzeug) 	{ fahrzeug.fahren();}
