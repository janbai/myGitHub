...
public class B06_MehrdiumArrays {

	public static void main(String[] args) {

		int [] a0= {1, 2, 3}; // new int []{1, 2, 3};
		System.out.println(a0); // array address

		int [][] a1 = new int [2][]; 
		System.out.println("1.a1[0] = " + a1[0]); // null
		
		a1[0] = new int [] {0, 77, 0};
		System.out.println("2. a1[0] = " + a1[0]);// array address
		System.out.println("3. a1[0][1] = " + a1[0][1]); // 77
		
		int [] temp = { 1, 2, 3, 4, 5};
		a1[1] = temp;
		System.out.println("4. a1[1][1] = " + a1[1][1]);
